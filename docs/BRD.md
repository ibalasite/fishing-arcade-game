...
- 12 個月可獲取 SOM：$120,000 USD（DAU 10K × 付費率 5% × ARPU $20 × 12 個月，同時驗證 SAM × 0.06% 市佔）
...
**競品研究摘要：**
- 歡樂捕魚類（台灣手遊廠）：ARPU 推估 $10-15，App Store 評分 4.0-4.3，30 日留存 < 30%（業界口碑，信心水準：中）
...
**Q5：商業模式是否可持續？**
A：DAU 10K × 5% 付費率 × $20 ARPU = 月營收 $10K。$200K 募資資金下，6 個月開發費用約 $100K，行銷 $60K，運維 $40K。若 DAU 達 10K 且付費率 5%，20 個月回收投資。悲觀情境（DAU 5K，付費率 3%）月營收 $3K，需延長回收期但不虧損。
...
| 競品 ARPU | $10-15 USD/月 | $20 USD/月（+35%） |
...
| **SOM**（12 個月可獲取市場） | $120,000 USD | DAU 10K × 付費率 5% × ARPU $20 × 12 個月；同時以 SAM × 0.06% 市佔雙向驗證 | 中 |
...
|---|------|---------|-----------|-----------|---------|-----------|
| OBJ-1 | DAU 達標 | 月活躍用戶達 10,000 | DAU 追蹤（Firebase Analytics）| 同類新品首年 DAU 5K-20K 範圍內 | 驗證市場規模假設 | 上線後 12 個月 |
| OBJ-2 | 付費轉化 | 付費率達 5% | 付費人數 / DAU | 業界成熟平台 3-8%，5% 屬中段 | 驗證商業模式可持續 | 上線後 6 個月 |
| OBJ-3 | 月營收達標 | 月均 ARPU $20，月營收 $10K | 月收入（金流後台）| OBJ-1 + OBJ-2 達成即自動達成 | 驗證財務模型 | 上線後 9 個月 |
...
| OBJ-3 月營收 $10K | 月收入後台確認（上線後 9 個月）| REQ-003 | BDD-REV-001 |
...
| 商業模式驗證 | 上線後 6 個月（6M）| 付費率 | 3%（競品 ARPU 推算）| 5% | 金流後台 |
...
| ❌ 13 歲以下未成年用戶 | 虛擬貨幣系統涉及未成年保護法規，MVP 階段排除 | 年齡驗證機制（上線前法務確認設計） |
...
| 競品 | 核心定位 | 技術架構 | 30日留存 | ARPU | 優勢 | 劣勢 | 我們的差異化 |
|------|---------|---------|:-------:|:----:|------|------|------------|
| **歡樂捕魚類**（台灣手遊廠）| 單機/弱聯網，爆金刺激 | 老世代（2015-2020 Lua/Cocos 2.x）| < 30%（業界口碑，信心水準：中）| $10-15 | 本土化運營成熟，App Store 評分 4.0-4.3，付費轉化率高 | 無真實多人競技，技能系統淺薄，架構老舊 | 真即時多人（Colyseus），4 種武器策略，目標 ARPU $20（+35%）|
...
> **North Star：月活付費玩家的平均月 ARPU（ARPU = 月收入 / 付費用戶數）**

選擇依據：ARPU 同時反映用戶規模（DAU）、付費轉化（付費率）與留存（付費用戶持續付費），是「用戶價值」的綜合體現。基準值（目標）：$20 USD/月。
...
| 個人資料保護法（台灣 PDPA）| 玩家帳號、付費紀錄、遊戲行為 | 資料蒐集、儲存、刪除程序 | Engineering | 🔲 EDD 設計中 |
...
| **R4** | 台灣法規風險：虛擬貨幣 + 博彩元素不合規 | 法規 | MEDIUM | HIGH | 🔴 HIGH | BRD 前法務預審（2026-04-30）；採「娛樂幣」而非「賭博代幣」定位 |
...
| **收入來源** | 道具內購（高倍砲台 / 鑽石補充 / 禮包）/ VIP 月訂閱（Phase 2，$5-15 USD）/ 限時活動付費（Phase 2）|
| **定價策略** | 免費入門（基礎砲台 + 初始金幣）+ 虛擬貨幣（鑽石）內購；VIP 月訂閱 $5-15 USD（Phase 2）|
...
timeline
    ...
    section Build - MVP（月 1-4）
        ...
        2026-07 / 月3 : 3 種魚類 + Boss 魚 + 完整房間管理
...
| **ARPU**（Average Revenue Per User）| 每位用戶平均收入，本產品目標月均 $20 USD |
...
| 競品 App Store 評測（歡樂捕魚類）| ARPU 推估 $10-15，App Store 評分 4.0-4.3，30 日留存 < 30%（業界口碑，信心水準：中）| §6 競品分析 |
